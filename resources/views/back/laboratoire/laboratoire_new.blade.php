                        ...
                        <div >
                            <form method="POST" action="{{ route('laboratoire.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-7">
                                        <select  id="typeproduit" class="form-control basic" name="typeproduit[]" multiple="multiple" required>
                                            <option value="" ></option>
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-7 offset-md-3">
                                        <a href="{{ route('laboratoire.list')}}" class="btn btn-dark">
