            ...
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        <div >
                            <form method="POST" action="{{ route('demande.update',$demande->id) }}" enctype="multipart/form-data" >
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <input id="nomdemandeur" type="text" class="form-control" placeholder="Nom" name="nomdemandeur" value="{{ $demande->nomdemandeur }}" required autofocus>

                                    </div>
                                    <div class="col-md-4">
                                        <input id="prenomdemandeur" type="text" class="form-control" placeholder="Prénom" name="prenomdemandeur" value="{{ $demande->prenomdemandeur }}" required autofocus>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="importateur" type="text" class="form-control" name="importateur" value="{{ $demande->importateur }}"  required autofocus>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="guceref" type="text" class="form-control" name="guceref" value="{{ $demande->guceref }}"   autofocus>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <select id="typeproduit" class="form-control basic" name="typeproduit_id"  required>
                                            ...
                                            @foreach($types as $type)
                                                <option @if($type->id == $demande->typeproduit_id) selected @endif value="{{ $type->id }}" >{{ $type->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="marque" type="text" class="form-control" name="marque" value="{{ $demande->marque }}" required autofocus>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="modele" type="text" class="form-control" name="modele" value="{{ $demande->modele }}" required autofocus>
                                    </div>
...
@section('javascripts')
    ...
    <script>
        ...
        var typepro = {{ $demande->typeproduit_id }};
        var labo = {{ $demande->laboratoire_id }};

        var laboratoire = $("#laboratoire");
        laboratoire.empty(); // remove old options
        $.each(laboarray[typepro], function(value,text) {
