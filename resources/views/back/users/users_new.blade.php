                    ...
                    <div class="widget-content widget-content-area">
                        <div >
                            <form method="POST" action="{{ route('users.store') }}">
                                ...
                                <div id="divlabo" class="form-group row d-none">
                                    <label for="laboratoire" class=" col-md-3 col-form-label text-md-right ">Laboratoire</label>
                                    <div class="col-md-7">
                                        <select  id="laboratoire" class="form-control basic" name="laboratoire"  >
                                            <option value="" ></option>
...
@section('javascripts')
    ...
    <script>
        ...
        $('#profil').on('change', function() {
            ...
            if (this.value == 3) {
                $('#divlabo').removeClass('d-none');
                $('#divlabo').show();
                $('#laboratoire').attr('required',true);

            } else {
                $('#divlabo').hide();
                $('#laboratoire').attr('required',false);
            }
