                    ...
                    <div class="widget-header">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <a href="{{ route('type.new') }}" style="margin: 20px"  class="btn btn-primary mb-4 mr-2"><i class="flaticon-plus-fill mr-1"></i> Ajouter</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive mb-4">
                            <table id="default-ordering" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                @foreach( $types as $type )
                                    <tr>
                                        <td>{{ $type->name }}</td>
                                        <td> @foreach($type->laboratoires as $laboratoire) {{ $laboratoire->name }},  @endforeach </td>
                                        <td>{{ $type->description }}</td>
                                        <td>{{ $type->created_at }}</td>

                                        <td class="text-center">
                                            <ul class="table-controls">
                                                <li><a href="{{ route('type.edit',$type->id) }}" data-toggle="tooltip" data-placement="top" title="Modifier"><i class="flaticon-edit-fill-2 bg-primary p-1 text-white br-6 mb-1"></i></a> </li>
